export default {
  ...
  DELIVERY_INFO_COUNTRIES: 'Countries',
  DELIVERY_INFO_PACKAGE_UP_TO_40: 'Package up to 40 €',
  DELIVERY_INFO_PACKAGE_FROM_40: 'Package from 40 €',
  DELIVERY_INFO_BULKY_GOODS: 'Bulky Goods (e.g. skis, boards, sleds, SUPs)',
  DELIVERY_INFO_BIKES: 'Bikes',
  DELIVERY_INFO_EXPRESS_PACKAGE: 'Express Package',
  DELIVERY_INFO_EXPRESS_BULKY_GOODS: 'Express Bulky Goods (e.g. Skis)',
  DELIVERY_INFO_EXPRESS_BIKES: 'Express Bikes',
  COUNTRY_DE: 'Germany',
  COUNTRY_AT: 'Austria',
  COUNTRY_AU: 'Australia',
  COUNTRY_CL: 'Chile',
  COUNTRY_CH: 'Switzerland',
  DELIVERY_INFO_TAX_FREE: 'Tax free',
  DELIVERY_INFO_NIF_REQUIRED: 'NIF of recipient necessary!',
}
